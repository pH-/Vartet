...
#define DOT4D(A,B) ((A)[0]*(B)[0] + (A)[1]*(B)[1] + (A)[2]*(B)[2] + (A)[3]*(B)[3])
...
#define ADD4D(O,A,B)			 {(O)[0] = (A)[0]+(B)[0]; \
							  (O)[1] = (A)[1]+(B)[1]; \
							  (O)[2] = (A)[2]+(B)[2]; \
							  (O)[3] = (A)[3]+(B)[3];}
...
#define MINUS4D(O,A,B)		 {(O)[0] = (A)[0]-(B)[0]; \
							  (O)[1] = (A)[1]-(B)[1]; \
							  (O)[2] = (A)[2]-(B)[2]; \
							  (O)[3] = (A)[3]-(B)[3];}
...
inline double vector4dLen(double vector[4])
{
